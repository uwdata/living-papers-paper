...
::: aside
Replica of an IEEE VIS 2021 short paper.
:::
...
::: figure {#err1d_impulse .latex:page position="t"}
...
::: figure {#err1d_penguins .latex:page position="t"}
...
![](figures/time_1d_penguins.svg){latex:width=100% width=100%}
...
::: figure {#err2d_cars .latex:page position="t"}
...
![](figures/time_2d_cars.svg){latex:width=100% width=70%}
